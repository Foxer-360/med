                    ...
                    return (React.createElement(React.Fragment, null,
                        ...
                        React.createElement("tr", { className: 'normalRow' },
                            ...
                            React.createElement("td", null,
                                React.createElement("p", null, item.morningHours.time),
                                React.createElement("p", null, item.morningHours.description)),
                            React.createElement("td", { className: 'circleCell' },
                                React.createElement(DividerCircles, null)),
                            React.createElement("td", null,
                                React.createElement("p", null, item.noonHours.time),
                                React.createElement("p", null, item.noonHours.description)),
                            React.createElement("td", { className: 'circleCell' },
                                React.createElement(DividerCircles, null)),
                            React.createElement("td", null,
                                React.createElement("p", null, item.afternoonHours.time),
                                React.createElement("p", null, item.afternoonHours.description)),
                            React.createElement("td", { className: 'circleCell' },
                                React.createElement(DividerCircles, null)),
                            React.createElement("td", null,
                                React.createElement("p", null, item.lateAfternoonHours.time),
                                React.createElement("p", null, item.lateAfternoonHours.description)))));
                })))));
};
