                ...
                (box.url2 || box.url3) &&
                    React.createElement("div", { style: { paddingLeft: 20 } },
                        box.url1 && (box.url2 || box.url3) &&
                            React.createElement(Link_1.default, __assign({}, box.url1, { className: 'downloadLink' }), box.url1Title ? box.url1Title : 'více informací'),
                        box.url2 && React.createElement(Link_1.default, __assign({}, box.url2, { className: 'downloadLink' }), box.url2Title ? box.url2Title : 'více informací'),
                        box.url3 && React.createElement(Link_1.default, __assign({}, box.url3, { className: 'downloadLink' }), box.url3Title ? box.url3Title : 'více informací'))),
