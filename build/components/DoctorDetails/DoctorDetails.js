...
var getClinicLink = function (clinic, building, officeFloor) {
    ...
    return (React.createElement("div", { className: 'policlinicInfo__item--content' },
        clinic && React.createElement("p", null,
            React.createElement(react_apollo_1.Query, { query: GET_CONTEXT }, function (_a) {
                var data = _a.data;
                return (clinic.url !== undefined ?
                    React.createElement(Link_1.default, { url: "/" + (data.languageData && data.languageData.code) + "/" + clinicUrl },
                        "Poliklinika ",
                        clinicName) :
...
var DoctorDetails = function (props) {
    var _a = props.data, doctorName = _a.doctorName, clinic = _a.clinic, building = _a.building, officeFloor = _a.officeFloor, phone = _a.phone, thirdColImage = _a.thirdColImage, thirdColContent = _a.thirdColContent, addInfo = _a.addInfo;
    ...
    return (React.createElement("section", { className: 'doctorDetails' },
        React.createElement("div", { className: "container" },
            ...
            React.createElement("div", { className: "row policlinicInfo__list" },
                ...
                (thirdColImage || thirdColContent) && React.createElement("div", { className: "col-12 col-lg" },
                    React.createElement("div", { className: 'policlinicInfo__item' },
                        thirdColImage &&
                            React.createElement(Media_1.default, { classes: 'policlinicInfo__item', type: 'image', data: thirdColImage }),
                        thirdColContent && thirdColContent.trim().length > 0 && React.createElement("div", { className: 'policlinicInfo__item--content' },
                            React.createElement(ReactMarkdown, { skipHtml: false, escapeHtml: false, source: thirdColContent }))))),
