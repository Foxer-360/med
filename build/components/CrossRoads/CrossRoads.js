    ...
    return (React.createElement("section", { className: 'crossRoads' },
        React.createElement("div", { className: 'container' },
            React.createElement("div", { className: 'crossRoads__wrapper' }, items &&
                items.map(function (item, index) { return (React.createElement(Link, { url: item.link && item.link.url, languageCode: props.languageCode, className: 'crossRoads__card', key: index },
