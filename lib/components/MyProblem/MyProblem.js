...
function (_super) {
  ...
  MyProblem.prototype.render = function () {
    ...
    return React.createElement("div", {
      ...
      className: 'myProblem'
    }, console.log('%c Emilio: ', 'background: #222; color: #83FFFF', this.props), React.createElement("h3", null, "M\u016Fj Probl\xE9m se t\xFDk\xE1"), React.createElement("p", null, "Klikn\u011Bte na \u010D\xE1st t\u011Bla se kterou m\xE1te probl\xE9m."), React.createElement("div", {
