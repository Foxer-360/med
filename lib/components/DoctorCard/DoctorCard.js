  ...
  return React.createElement("section", {
    ...
    return data && React.createElement(_DoctorSchedule.default, {
      data: data.map(function (_a) {
        var day = _a.day,
            eveningHoursdescription = _a.eveningHoursdescription,
            eveningOpeningHours = _a.eveningOpeningHours,
            morningHoursdescription = _a.morningHoursdescription,
            morningOpeningHours = _a.morningOpeningHours;
        return {
          day: day,
